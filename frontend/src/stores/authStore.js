...
class AuthStore {
    ...
    user = {
        id: 1, // Приклад ID
        // username: 'test_admin',
        email: 'test_admin@sport.local', // Змінено username на email для узгодження з моделлю User
        first_name: 'Тестовий',
    ...
    *login(usernameOrEmail, password) { // Змінено username на usernameOrEmail
        this.loading = true;
        this.error = null;
        try {
            ...
            // const response = yield apiClient.post("/auth/login", { email: usernameOrEmail, password }); // Змінено username на email
            // let tokenString;
            ...
            this.user = { id: 1, email: usernameOrEmail, first_name: 'Тестовий', last_name: 'Користувач', role: ROLES.ADMIN };
            this.accessToken = "fake-test-token";
